...
result = Vizier.query_region(field_RA_DEC, radius=Angle(2, "deg"), catalog=AAVOS)
...
AAVOS_table['nobs'] = result[0]['nobs']
...
USNO_B1 = 'I/284'			
result = Vizier.query_region(field_RA_DEC, radius=Angle(2, "deg"), catalog=USNO_B1)
...
USNO_table.write(output_cats + USNO_B1_output, format='ascii', overwrite =True) 
########################################################################################################

gaiaDR2 = 'I/345/gaia2'			
result = Vizier.query_region(field_RA_DEC, radius=Angle(2, "deg"), catalog=gaiaDR2)
...
gaiaDR2_table['Prober_motion_RA'] = result[0]['pmRA']
gaiaDR2_table['Prober_motion_RA_err'] = result[0]['e_pmRA']
gaiaDR2_table['Prober_motion_DEC'] = result[0]['pmDE']
gaiaDR2_table['Prober_motion_DEC_err'] = result[0]['e_pmDE']
gaiaDR2_table['Variability_flag'] = result[0]['phot_variable_flag'] #CAN'T pull from vizier? 
